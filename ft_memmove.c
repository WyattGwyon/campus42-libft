...
/*   Updated: 2025/05/22 21:05:22 by clouden          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_memmove(const char *label, char *buffer1, char *buffer2, void *src, size_t n, size_t offset_dest, size_t print_len)
{
...
int main(void)
{
    ...
    strcpy(buf1, src);
    strcpy(buf2, src);
    test_memmove("Test 1: overwrite with \"consectetur\" (5 bytes)", buf1, buf2, "consectetur", 5, 1, 22);

    // Test 2: Copy with embedded nulls "con\0sec\0\0te\0tur" (10 bytes)
    strcpy(buf1, src);
    strcpy(buf2, src);
    test_memmove("Test 2: copy with null bytes", buf1, buf2, "con\0sec\0\0te\0tur", 10, 1, 22);
    ...
    strcpy(buf1, src);
    strcpy(buf2, src);
    test_memmove("Test 4: overlapping src > dest", buf1, buf2, buf1 + 1, 8, 0, 22);
